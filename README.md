...
- [3.1.1 Shared Elements Across All Pages](#311-shared-elements-across-all-pages)
- [3.1.2 Home Page](#312-home-page)
- [3.1.3 Enquiry Form](#313-enquiry-form)
...
The **For Developers** page section includes a title, an image generated by consolidating several visuals into a single AI-produced composition (ChatGPT), and detailed information outlining the benefits for developers and creators, including the steps required to begin working immediately.
An enquiry button is positioned at the top of the section, aligning with the client’s objective of providing users with direct and immediate access to the enquiry form.
...
The page opens with a clearly defined, bold header, accompanied by a brief line of guidance to help users complete the form. The form is built using Bootstrap components and includes a series of structured input fields: the client’s name, email address, contact number, and a text area for the user’s detailed message.
...
Comprehensive manual testing was carried out across multiple devices to ensure full functionality and consistent performance.

**Devices Tested:**

- Laptop: MacBook Air 13 (2025) & ASUS X515 i5 (2023)
- Mobile: iPhone 16 & 12
...
All key features, interactive elements, and page layouts were reviewed on each device and browser combination to verify correct behaviour and responsiveness.
